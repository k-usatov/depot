...
global_money_amount_rub_from=['','from %s ruble','from %s rubles'];
...
Save='Save';
Secondary_education='Secondary and additional education';
Sex='Sex:';
Sex_fm='Female';
Sex_m='Male';
...
audio_claimed_geo='The audio file {audio} is not available in your region.';
audio_claimed_text_geo='The audio file {audio} is not available in your region.<br><br>You can {delete_link}.';
...
apps_edit='edit';
apps_editapp='Manage';
apps_games_of_group='Games of the Group';
apps_game_added_to_group='Game added to group';
...
apps_global_game_search_found=['','The search returned %s game','The search returned %s games'];
...
apps_no_games_in_group='There are no games connected to this group.';
...
help_ccform_legal_need_inform='You need to agree that the personal data mentioned above will be processed by the Site&#39;s Administration as well as the information provided in the complaint (including personal data) and the complaint itself  are to be forwarded to the person specified by you as the user who has uploaded the content in question, moreover  all this information may be forwarded to the person who objects the complaint.';
...
help_ccform_natural_need_inform='You need to agree that the personal data mentioned above will be processed by the Site&#39;s Administration as well as the information provided in the complaint (including personal data) and the complaint itself  are to be forwarded to the person specified by you as the user who has uploaded the content in question, moreover  all this information may be forwarded to the person who objects the complaint.';
...
mail_error='Error';
mail_im_get_invitation_link='Link to the conversation';
mail_im_joined_chat_from_invitation=['','{from} joined the conversation','{from} joined the conversation'];
mail_marked_as_spam='Message marked as spam and deleted.';
// section = 22; version = 113;
...
profile_oph_crop_desc='Now select area for your profile miniature.<br>The miniature will appear next to your posts, private messages and comments.';
// section = 31; version = 136;

reg_sex_not_set='Not specified';
// section = 35; version = 64;
...
mobile_mail_im_joined_chat_from_invitation=['','{from} joined the conversation','{from} joined the conversation'];
...
// section = 61; version = 35;

adslight_age_restriction_none='Do not specify';
// section = 67; version = 3;

print_close_text='Your stickers are being created at the moment. Are you sure you want to close the page?';
print_close_title='Close page';
print_epsp_hint='Vector image format for printing equipment.<br>{tag}The file contains curves and bleeds for cutting{/tag}';
print_eps_hint='Vector image format';
print_flood_error='This action is being carried out too often, please try again later.';
print_group_change_address='You can change the community link in {link}settings{/link}.';
print_group_not_found='Community not found';
print_group_no_address='The community %s does not have a short web address. Stickers can be created only for communities with a short address like <b>vk.com/cafe.</b>';
print_group_placeholder='Please enter a community name or a link';
print_png_hint='Raster image format';
print_stickers_example='Stickers examples';
print_user_change_address='You can change your profile link in {link}settings{/link}. ';
print_user_no_address='%s does not have a short web address. Stickers can be created only for communities with a short address like <b>vk.com/cafe.</b>';
// section = 69; version = 34;

chronicle_landing_title='New photo app';
// section = 70; version = 4;
